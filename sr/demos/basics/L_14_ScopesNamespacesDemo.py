...
def level2():
    ...
    def level3(short):
        ...
        level3(True) # This is recursive call, level_3_value inside this call is a local scoped variable, changing it's value won't change the value in level3() function
